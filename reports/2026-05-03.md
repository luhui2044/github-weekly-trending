...
- [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)
  ...
  - 热度指标：`stars 15988` `forks 5222` `Jupyter Notebook` `最近推送 2026-04-30`
- [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM)
  ...
  - 功能特点：围绕 AI/LLM 能力构建，重点解决模型调用、智能体编排、知识检索、推理服务或自动化工作流等问题。
  - 典型场景：适合用于智能助手、企业知识库、研发自动化、AI 原型验证、模型应用集成等场景。
  - 热度指标：`stars 13542` `forks 2344` `Python` `最近推送 2026-05-03`
...
- [grpc/grpc-go](https://github.com/grpc/grpc-go)
  ...
  - 热度指标：`stars 22921` `forks 4665` `Go` `最近推送 2026-04-30`
- [qax-os/excelize](https://github.com/qax-os/excelize)
  ...
  - 功能特点：围绕 AI/LLM 能力构建，重点解决模型调用、智能体编排、知识检索、推理服务或自动化工作流等问题。
  - 典型场景：适合用于智能助手、企业知识库、研发自动化、AI 原型验证、模型应用集成等场景。
  - 热度指标：`stars 20544` `forks 1900` `Go` `最近推送 2026-04-30`
- [a-h/templ](https://github.com/a-h/templ)
  - 项目描述：A language for writing HTML user interfaces in Go.
  - 功能特点：偏向后端服务与基础设施能力，通常关注 API、数据处理、服务治理、云原生部署或系统性能。
  - 典型场景：适合用于业务后端、平台服务、微服务治理、数据接口、云原生应用和企业级系统集成。
  - 热度指标：`stars 10271` `forks 352` `Go` `最近推送 2026-04-27`
...
- [rust-embedded/awesome-embedded-rust](https://github.com/rust-embedded/awesome-embedded-rust)
  ...
  - 热度指标：`stars 7841` `forks 475` `Unknown` `最近推送 2026-04-28`
- [mozilla/uniffi-rs](https://github.com/mozilla/uniffi-rs)
  ...
  - 热度指标：`stars 4552` `forks 306` `Rust` `最近推送 2026-05-02`
- [aya-rs/aya](https://github.com/aya-rs/aya)
  ...
  - 功能特点：面向开发者效率提升，通常提供命令行工具、调试辅助、工程自动化、代码生成或本地开发体验优化。
  - 典型场景：适合用于团队研发流程、CI/CD 辅助、本地开发提效、代码质量治理和工程脚手架建设。
  - 热度指标：`stars 4515` `forks 420` `Rust` `最近推送 2026-05-03`
